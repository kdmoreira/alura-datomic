(ns alura-datomic.course-02.aula04
  (:use clojure.pprint)
...
(db/todos-os-produtos-da-categoria-fw (d/db conn) "Eletrônicos")
(db/todos-os-produtos-da-categoria-fw (d/db conn) "Esporte")

(db/todos-os-produtos-da-categoria-bw (d/db conn) "Eletrônicos")
(db/todos-os-produtos-da-categoria-bw (d/db conn) "Esporte")
